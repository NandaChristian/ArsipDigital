    ...
    <div className="page-content">
      <div className="d-flex align-items-center">
        ...
        <div className="search-bar flex-grow-1 d-flex align-items-center" style={{marginBottom: 10}}>
          <img src="/assets/images/arrow-left.png" alt style={{width: 30, height: 30, marginRight: 10}} /><h4 style={{marginBottom: 0, color: 'black'}}>Lemari</h4>
        </div>
        </Link>
      </div>
      <div className="d-flex align-items-center">
      ...
      <div className="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
        <div className="col">
          <div className="card">
            <div className="gambar d-flex justify-content-center">
              <img src="/assets/images/rak.png" className="card-img-top" style={{width: 104, height: 146, marginTop: 15}} alt="..." />
            </div>
            <div className="card-body">
              <h5 className="card-title">Lemari 1</h5>
            </div>
             <ul className="list-group list-group-flush" style={{borderTop: "none"}}>
              ...
              <Link to="/dataArsipStaff/lemariStaff/rakStaff" className="link">
              <li className="list-group-item" style={{border: 'none'}}>
                <div className="col">
                  <div className="card radius-10 shadow-none">
                    <div className="card-body-arsip">
                      <div className="d-flex align-items-center">
                        <div>
                          <p className="mb-0 text-secondary">Folder</p>
        ...
        <div className="col">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">Lemari 2</h5>
            </div>
            <ul className="list-group list-group-flush" style={{borderTop: "none"}}>
              <Link to="/dataArsipStaff/lantaiStaff" className="link">
              <li className="list-group-item" style={{border: 'none'}}>
              ...
              <Link to="/dataArsipStaff/rakStaff" className="link">
              <li className="list-group-item" style={{border: 'none'}}>
                <div className="col">
                  <div className="card radius-10 shadow-none">
                    <div className="card-body-arsip">
        ...
        <div className="col">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">Lemari 3</h5>
            </div>
            <ul className="list-group list-group-flush" style={{borderTop: "none"}}>
              <Link to="/dataArsipStaff/lantaiStaff" className="link">
              <li className="list-group-item" style={{border: 'none'}}>
