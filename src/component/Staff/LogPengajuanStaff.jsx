    ...
    <div className="page-content">
      ...
      <div className="dropdown bg-white my-3" style={{height: 38}}> 
        <div className="d-flex justify-content-between">
          <a href="#" className="btn btn-white btn-sm dropdown-toggle dropdown-toggle-nocaret my-3 mt-0 p-2 pe-0" style={{border: 'none'}} data-bs-toggle="dropdown" data-display="static">Tipe<i className="bx bxs-chevron-down ms-5" /></a>
          <a href="#" className="btn btn-white btn-sm dropdown-toggle dropdown-toggle-nocaret my-3 mt-0 p-2 pe-0" style={{border: 'none'}} data-bs-toggle="dropdown" data-display="static">Kategori<i className="bx bxs-chevron-down ms-5" /></a>
          <a href="#" className="btn btn-white btn-sm dropdown-toggle dropdown-toggle-nocaret my-3 mt-0 p-2 pe-0" style={{border: 'none'}} data-bs-toggle="dropdown" data-display="static">Status<i className="bx bxs-chevron-down ms-5" /></a>
        </div>
      </div>
      <div className="customers-list mb-3">
        <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
          ...
          <div className="d-flex justify-content-between p-3 pb-0 pt-0">
            <div className="mb-3">
              <button type="button" className="btn btn-primary px-5 radius-30">Lihat Arsip</button>
            </div>
            <div className="mb-3">
              <button type="button" className="btn btn-outline-primary px-5 radius-30">Download Arsip</button>
            </div>	
            <div className="mb-3">
              <button type="button" className="btn btn-outline-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#kembaliFisik">Kembalikan Arsip</button>
            </div>
          </div>
        </div>
        <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
          ...
          <div className="d-flex justify-content-center p-3 pb-0 pt-0">
            <div className="mb-3">
              <button type="button" className="btn btn-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#kembaliFisik">Kembalikan Arsip</button>
            </div>
          </div>
        </div>
        <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
        ...
        <div className="customers-list mb-3">
          <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
            ...
            <div className="d-flex justify-content-between p-3 pb-0 pt-0">
              ...
              <div className="mb-3">
                <button type="button" className="btn btn-outline-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#kembaliDigital">Kembalikan Arsip</button>
              </div>
            </div>
          </div>
          <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
            ...
            <div className="d-flex justify-content-center p-3 pb-0 pt-0">
              <div className="mb-3">
                <button type="button" className="btn btn-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#kembaliDigital">Kembalikan Arsip</button>
              </div>
            </div>
          </div>
          <div className="customers-list-item cursor-pointer bg-white" style={{marginBottom: 15}}>
