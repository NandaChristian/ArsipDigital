...
export default function NamaMaster() {
    ...
    const handleDelete = async (nameItem) => {
        if (window.confirm("Peringatan: Menghapus item ini akan menghapus semua sub-item di dalamnya!")) {
            try {
                const response = await fetch(import.meta.env.VITE_API_URL + '/api/names/' + nameItem.uuid, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
        ...
        <div className="wrapper">
            ...
            <div className="page-wrapper">
                <div className="page-content">
                        ...
                        <div className="col-12 col-lg-2" style={{ width: '22%', marginRight: '15px' }}>
                            <div className="card">
                                <div className="card-body-master">
                                    ...
                                    <div>
                                        <h6 className="my-2" style={{ textAlign: 'center', whiteSpace: 'nowrap' }}>Nama Data Master</h6>
                                    </div>
                                    <Sidebar />
                                </div>
                            </div>
                    ...
                    {/* Modal Tambah User */}
                    <div className="modal fade" id="tambahNamaMaster" tabIndex={-1} aria-hidden="true">
                        <div className="modal-dialog modal-dialog-scrollable">
                            <div className="modal-content">
                                <div className="modal-header" style={{ border: 'none' }}>
                                    <div className style={{ margin: 'auto' }}>
                                        <h5 className="modal-title align-items-center">Penambahan Nama Arsip</h5>
                                    </div>
                                    <div>
                                ...
                                <div className="modal-body">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" value={name.name} onChange={(e) => setName({ name: e.target.value })} name="name" className="form-control radius-30" placeholder="Masukkan Kategori Arsip" />
                                        </div>
                                        <div className="d-flex align-items-center pb-0 pt-0 gap-3">
                                            <div className="w-50">
