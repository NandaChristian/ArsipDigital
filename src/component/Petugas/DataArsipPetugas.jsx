  ...
  <div className="page-wrapper">
    <div className="page-content">
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="user-box">
          <div className="col mb-3">
            <button type="button" className="btn btn-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#modaltambahFisik">Tambah</button>
          </div>
        </div>
      </div>
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="user-box">
          <div className="col mb-3">
            <button type="button" className="btn btn-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#modaltambahDigital">Tambah</button>
          </div>
        </div>
      </div>
      <div className="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
