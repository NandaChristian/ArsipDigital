    ...
    <div className="pim-row d-flex">
      <div className="row row-cols-xl-4">
        ...
        <div className="col">
          <div className="card radius-10">
            <div className="card-body">
              <div className="text-center">
                <div className="widgets-icons rounded-circle mx-auto bg-light-primary text-primary mb-3"><img src="assets/images/list.png" alt />
                </div>
        ...
        <div className="col">
          <div className="card radius-10">
            <div className="card-body">
              <div className="text-center">
                <div className="widgets-icons rounded-circle mx-auto bg-light-primary text-primary mb-3"><img src="assets/images/users.png" alt />
                </div>
        ...
        <div className="col">
          <div className="card radius-10">
            <div className="card-body">
              <div className="text-center">
                <div className="widgets-icons rounded-circle mx-auto bg-light-danger text-danger mb-3"><img src="assets/images/circle-x.png" alt />
                </div>
      ...
      <div className="col">
        <div className="card" style={{height: 300}}>
          <div className="card-body" style={{backgroundColor: '#3468F8', borderRadius: 10}}>
            <div className="text-center">
              <div className="widgets-icons rounded-circle mx-auto bg-white text-white mb-3"><img src="assets/images/file-clock.png" alt />
              </div>
          ...
          <div className="card-body">
            <div className="d-flex align-items-center">
              ...
              <div className="font-22 ms-auto">
                <button type="button" className="btn btn-white radius-30 p-2 pe-3 ps-3" style={{color: 'blue'}}>Tindakan <img src="assets/images/arrow-up-right.png" alt /></button>
              </div>
            </div>
          </div>
          <div className>
      ...
      <div className="card radius-10 w-100">
        <div className="card-body">
          ...
          <div className="kotak-file p-3 pt-0 pb-0">
            ...
            <div className="row border 1 radius-10 pt-3 pb-3">
              <div className="col-md-2 text-end d-flex align-items-center">
                <img src="assets/images/iconpdf.png" width={60} height={60} alt />
              </div>
              <div className="col-md-10">
      ...
      <div className="card radius-10 w-100">
        <div className="card-body">
          <ul className="nav nav-pills mb-3 d-flex justify-content-between" role="tablist">
            ...
            <li className="n~av-item" role="presentation" style={{width: '30%'}}>
              <a className="nav-link" data-bs-toggle="pill" href="#primary-pills-profile" role="tab" aria-selected="false">
                <div className="d-flex align-items-center justify-content-center">
                  <div className="tab-title">User Yang Sering Akses</div>
                </div>
    ...
    <div className="col d-flex">
      <div className="card radius-10 w-100">
        <div className="card-body">
          ...
          <a href="javascript:;" className="list-group-item border-0">
            <div className="d-flex mb-4">
              ...
              <div className="flex-grow-1 ms-2 align-items-center d-flex">
